    ...
    <div style="display: flex; background-color: white;width: 50%; border-radius: 8px; overflow: hidden">
      ...
      <div style="flex: 1; display: flex; align-items: center; justify-content: center">
        <el-form :model="user" style="width: 80%" :rules="rules" ref="loginRef">
          ...
          <div style="display: flex">
            <div style="flex: 1">还没有账号?请<span style="color: #1890ff; cursor: pointer " @click="$router.push('/register')">注册</span></div>
            <!--            悬停出现一个小手-->
            <div style="flex: 1; text-align: right">
              <span style="color: #1890ff; cursor: pointer">忘记密码</span></div>
          </div>
        </el-form>
      </div>
    </div>
